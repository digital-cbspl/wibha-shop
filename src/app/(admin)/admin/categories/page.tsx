...
// Mock data matching your database structure (categories table)
const categories = [
    { id: 1, name: "Clothing", slug: "clothing", items: 124, isActive: true, date: "Apr 15, 2026" },
    { id: 2, name: "Craft", slug: "craft", items: 45, isActive: true, date: "Apr 15, 2026" },
    { id: 3, name: "Wedding", slug: "wedding", items: 18, isActive: true, date: "Apr 15, 2026" },
    { id: 4, name: "Accessories", slug: "accessories", items: 56, isActive: true, date: "Apr 15, 2026" },
    { id: 5, name: "Artisans", slug: "artisans", items: 12, isActive: true, date: "Apr 15, 2026" },
    { id: 6, name: "Sales & Offers", slug: "sales", items: 0, isActive: false, date: "Apr 15, 2026" },
];
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="font-serif text-2xl font-medium text-[#1a1a1a]">Categories</h1>
                    <p className="text-sm text-gray-500 mt-1">Organize your products into top-level groups.</p>
                </div>
                <Link 
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm shadow-gray-200/20 overflow-hidden flex flex-col">
                    ...
                    <table className="w-full text-left border-collapse min-w-[700px]">
                        <thead>
                            <tr className="bg-gray-50/50 border-b border-gray-100">
                                <th className="py-4 px-6 md:px-8 text-[10px] font-bold tracking-widest text-gray-400 uppercase w-[300px]">Category Details</th>
                                <th className="py-4 px-6 text-[10px] font-bold tracking-widest text-gray-400 uppercase">Slug</th>
                                <th className="py-4 px-6 text-[10px] font-bold tracking-widest text-gray-400 uppercase">Total Items</th>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {categories.map((category) => (
                                <tr key={category.id} className="hover:bg-gray-50/30 transition-colors group">
                                    ...
                                    <td className="py-4 px-6 md:px-8">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 border border-gray-100 group-hover:bg-[#18582e]/5 group-hover:text-[#18582e] group-hover:border-[#18582e]/20 transition-colors">
                                                <FolderGit size={18} strokeWidth={1.5} />
                                            </div>
                                            <div>
                                                <p className="text-sm font-medium text-gray-900 group-hover:text-[#18582e] transition-colors">{category.name}</p>
                                                <p className="text-xs text-gray-400 mt-0.5">Added {category.date}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    {/* Items Count */}
                                    <td className="py-4 px-6">
                                        <p className="text-sm font-medium text-gray-700">{category.items} products</p>
                                    </td>
                                    ...
                                    <td className="py-4 px-6">
                                        <span className={`inline-flex items-center justify-center px-2.5 py-1 text-[10px] font-bold rounded-md uppercase tracking-wider
                                            ${category.isActive ? 'bg-[#18582e]/10 text-[#18582e]' : 'bg-gray-100 text-gray-500'}`}>
                ...
                <div className="p-5 border-t border-gray-50 flex items-center justify-between text-sm">
                    <span className="text-gray-500 font-medium text-xs">Showing 1 to 6 of 6 categories</span>
