...
// Mock data based on your database structure (varieties joined with materials)
const varieties = [
    { id: 1, name: "Habaspuri Saree", slug: "habaspuri-saree", material: "Cotton", isActive: true, date: "Apr 15, 2026" },
    { id: 2, name: "Dongoria Saree", slug: "dongoria-saree", material: "Cotton", isActive: true, date: "Apr 15, 2026" },
    { id: 3, name: "Ikat Saree", slug: "ikat-saree", material: "Cotton", isActive: true, date: "Apr 15, 2026" },
    { id: 4, name: "Berhmpur Silk", slug: "berhmpur-silk", material: "Silk", isActive: true, date: "Apr 15, 2026" },
    { id: 5, name: "Pattachitra", slug: "pattachitra", material: "Tusser", isActive: true, date: "Apr 15, 2026" },
    { id: 6, name: "Warli painting", slug: "warli-painting", material: "Tusser", isActive: false, date: "Apr 15, 2026" },
];
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="font-serif text-2xl font-medium text-[#1a1a1a]">Varieties / Art Forms</h1>
                    <p className="text-sm text-gray-500 mt-1">Manage the specific styles or variations tied to your materials.</p>
                </div>
                <Link 
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm shadow-gray-200/20 overflow-hidden flex flex-col">
                    ...
                    <div className="relative w-full sm:w-auto">
                        ...
                        {isFilterOpen && (
                            <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-xl shadow-gray-200/50 border border-gray-100 z-20 p-5 animate-in fade-in slide-in-from-top-2 duration-200">
                                ...
                                {/* Material Filter */}
                                <div className="mb-6">
                                    <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-3">Parent Material</h3>
                                    <div className="space-y-2.5 max-h-40 overflow-y-auto custom-scroll pr-2">
                                        <label className="flex items-center gap-3 cursor-pointer group">
                                            ...
                                            <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Cotton</span>
                                        </label>
                                        <label className="flex items-center gap-3 cursor-pointer group">
                                            <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#18582e] focus:ring-[#18582e]/20 cursor-pointer" />
                                            <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Silk</span>
                                        </label>
                                        <label className="flex items-center gap-3 cursor-pointer group">
                                            <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#18582e] focus:ring-[#18582e]/20 cursor-pointer" />
                                            <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Tusser</span>
                                        </label>
                                        <label className="flex items-center gap-3 cursor-pointer group">
                                            <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#18582e] focus:ring-[#18582e]/20 cursor-pointer" />
                                            <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Linen</span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <table className="w-full text-left border-collapse min-w-[700px]">
                        <thead>
                            <tr className="bg-gray-50/50 border-b border-gray-100">
                                <th className="py-4 px-6 md:px-8 text-[10px] font-bold tracking-widest text-gray-400 uppercase w-[300px]">Variety Name</th>
                                <th className="py-4 px-6 text-[10px] font-bold tracking-widest text-gray-400 uppercase">Slug</th>
                                <th className="py-4 px-6 text-[10px] font-bold tracking-widest text-gray-400 uppercase">Parent Material</th>
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {varieties.map((variety) => (
                                <tr key={variety.id} className="hover:bg-gray-50/30 transition-colors group">
                                    ...
                                    <td className="py-4 px-6 md:px-8">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-gray-900 group-hover:text-[#18582e] transition-colors">{variety.name}</p>
                                                <p className="text-xs text-gray-400 mt-0.5">Added {variety.date}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="py-4 px-6">
                                        <span className={`inline-flex items-center justify-center px-2.5 py-1 text-[10px] font-bold rounded-md uppercase tracking-wider
                                            ${variety.isActive ? 'bg-[#18582e]/10 text-[#18582e]' : 'bg-gray-100 text-gray-500'}`}>
                                            {variety.isActive ? 'Active' : 'Draft'}
                                        </span>
                                    </td>
                ...
                <div className="p-5 border-t border-gray-50 flex items-center justify-between text-sm">
                    <span className="text-gray-500 font-medium text-xs">Showing 1 to 6 of 16 varieties</span>
