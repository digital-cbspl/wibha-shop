        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="font-serif text-2xl font-medium text-[#1a1a1a]">Add Material</h1>
                        <p className="text-sm text-gray-500 mt-1">Define a raw material used for a specific product type.</p>
                    </div>
                </div>
            ...
            <form className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm shadow-gray-200/20 p-6 md:p-8">
                        ...
                        <div className="space-y-5">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Material Name <span className="text-red-500">*</span></label>
                                <input 
                                    type="text" 
                                    required 
                ...
                <div className="space-y-8">
                    ...
                    {/* Organization / Parent Product Type */}
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm shadow-gray-200/20 p-6 md:p-8">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-2">
                                Select the product type this material belongs to.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 leading-relaxed">
                                E.g., <strong className="text-gray-700">Sarees</strong> (Product Type) &rarr; <strong className="text-gray-700">Cotton</strong> (Material).
                            </p>
                        </div>
                    </div>
